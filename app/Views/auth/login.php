<div class="auth-copy-block">
    ...
    <p class="mt-2 text-sm font-medium text-slate-500">Acesse sua conta Alpha Planilhas e continue seu planejamento.</p>
</div>
...
<form method="post">
    ...
    <label class="block text-sm font-bold">E-mail
        <input class="app-input mt-2" type="email" name="email" value="<?= e($old['email'] ?? '') ?>" placeholder="Seu e-mail" autocomplete="email" required autofocus>
    </label>
    <label class="block text-sm font-bold">Senha
        <span class="password-toggle-field mt-2">
            <input class="app-input password-toggle-input" type="password" name="password" placeholder="Sua senha" autocomplete="current-password" required>
    ...
    <div class="auth-form-options">
        ...
        <a href="<?= url('/register') ?>" class="auth-inline-link">Criar conta</a>
    </div>
    <button class="app-button auth-submit-button">Entrar</button>
</form>
